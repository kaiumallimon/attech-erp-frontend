...
export function HeroSelect({
  ...
  return (
    <div ref={containerRef} className={`relative inline-block ${className}`}>
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1.5 min-w-[200px] max-h-60 w-full overflow-y-auto rounded-3xl bg-white p-1.5 shadow-xl border border-[#E5E7EB] animate-fadeIn focus:outline-none">
          {options.length === 0 ? (
